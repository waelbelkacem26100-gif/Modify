...
## Corpus Check
- 246 files · ~113,376 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1175 nodes · 2559 edges · 105 communities (84 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 42 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e18cc3f4`
...
Cohesion: 0.10
Nodes (24): POST(), GET(), buildInstallUrl(), duplicateTheme(), getBlogs(), getOrCreateBlog(), getOrdersForDateRange(), putAssetSrc() (+16 more)
...
Cohesion: 0.13
Nodes (10): SCORE, ORDER, PaidPlanId, Plan, PlanId, PLANS, Subscription, statusConfig (+2 more)

### Community 11 - "Community 11"
Cohesion: 0.21
Nodes (14): Alert, monitorCompetitors(), SupabaseClient, PriceSuggestion, suggestPrices(), SupabaseClient, predictTrends(), SupabaseClient (+6 more)

### Community 12 - "Community 12"
Cohesion: 0.13
Nodes (23): anthropic, hdr(), OptimizationOutput, optimizeProduct(), OptimizeReport, ProductImage, ShopifyProductFull, SupabaseClient (+15 more)

### Community 13 - "Community 13"
Cohesion: 0.15
Nodes (16): POST(), POST(), GET(), GET(), ConnectPage(), POST(), DELETE(), GuidePage() (+8 more)
...
Cohesion: 0.23
Nodes (14): generateMissionContent(), MISSION_TO_GUIDE_TYPE, MissionType, missionTypeForProblem(), guideProblems(), GuideRow, latestCompletedAudit(), listMissions() (+6 more)
...
Cohesion: 0.06
Nodes (30): 10. Bugs Potentiels, 1. Routes & API, 2. Composants, 3. Libs, 4. Crons, 5. Webhooks, 6. Variables d'Environnement, 7. Dépendances (+22 more)
...
Cohesion: 0.12
Nodes (13): AnalyseContent(), CAT_ICON, catMeta(), euros(), FALLBACK_CAT_ICON, Filter, Prio, PRIORITY_META (+5 more)
...
Cohesion: 0.27
Nodes (8): KIND_META, ACTION_LABEL, buildPiloteFeed(), PiloteEntry, relativeFr(), SupabaseClient, PilotePage(), Store

### Community 25 - "Community 25"
Cohesion: 0.15
Nodes (25): POST(), applyGroupA(), applyGroupAAltText(), applyGroupADescriptions(), applyGroupAMeta(), classifyGroupASubtype(), findRelevantFile(), GroupASubtype (+17 more)
...
Cohesion: 0.21
Nodes (17): applyGroupAJsonLd(), reinstallAppBlocks(), SupabaseClient, logAction(), SupabaseClient, parseGroupABackup(), restoreGroupABackup(), appBlockForFix() (+9 more)
...
Cohesion: 0.22
Nodes (11): GUIDE_TYPE_TO_MISSION, Metier, METIER_META, METIER_ORDER, MISSION_TO_METIER, CopilotMissions(), euros(), GuideDetail (+3 more)

### Community 38 - "Community 38"
Cohesion: 0.14
Nodes (8): Props, StoreMode, Tab, CAPABILITY_META, CapabilityMeta, fixCapability, fixMode(), whatChanged()
...
Cohesion: 0.18
Nodes (6): Props, AgentChatProps, InlineAction, MISSION_STARTERS, Msg, STARTERS
...
Cohesion: 0.31
Nodes (6): POST(), isPaidPlan(), createCheckoutSession(), stripe, POST(), POST()
...
Cohesion: 0.22
Nodes (9): LineItem, recordOrderPerformance(), SupabaseClient, ingestWebhook(), POST(), verifyWebhookHmac(), POST(), POST() (+1 more)
...
Cohesion: 0.16
Nodes (19): POST(), buildAgentContext(), euros(), SupabaseClient, getSoldProductIds(), planFor(), anthropic, extractJsonArray() (+11 more)
...
Cohesion: 0.18
Nodes (15): captureFixScreenshot(), captureScreenshot(), productUrlForStore(), ScreenshotWhen, storefrontIsGated(), SupabaseClient, uploadScreenshot(), APPLY_ACTIONS (+7 more)
...
Cohesion: 0.67
Nodes (3): auditProgress(), GET(), POST()
...
## Knowledge Gaps
- **421 isolated node(s):** `PreToolUse`, `trust_badges`, `social_proof`, `urgency`, `json_ld` (+416 more)
...
- **Why does `createServiceRoleClient()` connect `Community 13` to `Community 0`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 11`, `Community 14`, `Community 16`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 32`, `Community 48`, `Community 53`, `Community 71`, `Community 72`, `Community 73`, `Community 76`, `Community 78`, `Community 79`, `Community 80`, `Community 94`, `Community 99`, `Community 101`, `Community 104`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `Store` connect `Community 24` to `Community 0`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 20`, `Community 21`, `Community 25`, `Community 32`, `Community 48`, `Community 71`, `Community 72`, `Community 73`, `Community 76`, `Community 78`, `Community 79`, `Community 80`, `Community 85`, `Community 94`, `Community 99`, `Community 101`, `Community 104`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `logAction()` connect `Community 32` to `Community 2`, `Community 3`, `Community 6`, `Community 104`, `Community 73`, `Community 11`, `Community 12`, `Community 76`, `Community 78`, `Community 14`, `Community 16`, `Community 48`, `Community 25`, `Community 94`?**
