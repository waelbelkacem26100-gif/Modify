...
## Corpus Check
- 250 files · ~115,150 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1189 nodes · 2588 edges · 107 communities (93 shown, 14 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 42 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `18b15ad0`
...
Cohesion: 0.13
Nodes (27): anthropic, competitiveAgent, funnelAgent, mobileAgent, productPagesAgent, anthropic, AuditAgent, calibration() (+19 more)
...
Cohesion: 0.11
Nodes (4): categories, QA, steps, METIERS
...
Cohesion: 0.10
Nodes (26): POST(), GET(), buildInstallUrl(), createBackupTheme(), duplicateTheme(), getBlogs(), getOrCreateBlog(), getOrdersForDateRange() (+18 more)
...
Cohesion: 0.17
Nodes (10): POST(), ORDER, isPaidPlan(), PaidPlanId, Plan, PlanId, PLANS, createCheckoutSession() (+2 more)

### Community 11 - "Community 11"
Cohesion: 0.21
Nodes (13): Alert, monitorCompetitors(), SupabaseClient, PriceSuggestion, suggestPrices(), SupabaseClient, predictTrends(), SupabaseClient (+5 more)

### Community 12 - "Community 12"
Cohesion: 0.18
Nodes (17): anthropic, hdr(), OptimizationOutput, optimizeProduct(), OptimizeReport, ProductImage, ShopifyProductFull, SupabaseClient (+9 more)

### Community 13 - "Community 13"
Cohesion: 0.14
Nodes (19): POST(), POST(), GET(), GET(), ConnectPage(), POST(), POST(), DELETE() (+11 more)
...
Cohesion: 0.18
Nodes (8): beforeAfter(), CATEGORY_PRESENTATION, fixMode(), MODE_PRESENTATION, PRIORITY_PRESENTATION, whatChanged(), IssueCategory, PriorityLevel
...
Cohesion: 0.12
Nodes (13): CATEGORY_ORDER, AnalyseContent(), CAT_ICON, euros(), FALLBACK_CAT_ICON, Filter, Prio, PRIORITY_META (+5 more)
...
Cohesion: 0.19
Nodes (22): applyAnchorInjection(), applyGroupA(), applyGroupAAltText(), applyGroupADescriptions(), applyGroupAMeta(), classifyGroupASubtype(), findRelevantFile(), GroupASubtype (+14 more)
...
Cohesion: 0.20
Nodes (9): 10. Clerk Auth, 11. Resend, 2. Architecture des fichiers, Admin bypass, Comment l'auth est geree, Documentation Technique Exhaustive — Modify, Emails envoyes, Table des matieres (+1 more)

### Community 30 - "Community 30"
Cohesion: 0.16
Nodes (15): checkAndRestore(), hdr(), readSeoApplied(), RegressionResult, SeoApplied, SupabaseClient, getProduct(), getProductSeoMeta() (+7 more)
...
Cohesion: 0.14
Nodes (24): applyGroupAJsonLd(), reinstallAppBlocks(), SupabaseClient, SupabaseClient, parseGroupABackup(), restoreGroupABackup(), AppBlockSpec, enableProductAppBlock() (+16 more)
...
Cohesion: 0.39
Nodes (6): planById(), Subscription, buildSuiviData(), ResultatsPage(), statusConfig, SubscriptionPage()
...
Cohesion: 0.19
Nodes (6): POST(), StoreMode, Tab, CAPABILITY_META, CapabilityMeta, fixCapability
...
Cohesion: 0.21
Nodes (11): buildAgentContext(), euros(), SupabaseClient, getSoldProductIds(), anthropic, extractJsonArray(), GeneratedProduct, getStoreContext() (+3 more)
...
Cohesion: 0.29
Nodes (8): performanceSeoAgent, geoBlock(), GeoSignals, AuditAgentInput, PageForAudit, ProductForAudit, Strength, PageSpeedResult

### Community 71 - "Community 71"
Cohesion: 0.26
Nodes (10): AccessibilityFindings, contrastRatio(), extractThemeColorPairs(), hexToRgb(), htmlChecks(), luminance(), runAccessibilityChecks(), ThemeColors (+2 more)
...
Cohesion: 0.39
Nodes (6): generateWinningProducts(), GET(), COUNT_BY_PLAN, GET(), POST(), userStore()
...
Cohesion: 0.31
Nodes (9): scheduleAfterScreenshot(), captureFixScreenshot(), captureScreenshot(), productUrlForStore(), ScreenshotWhen, storefrontIsGated(), SupabaseClient, uploadScreenshot() (+1 more)
...
Cohesion: 0.24
Nodes (8): auditProgress(), runAuditStep(), runFullAuditSequential(), deriveStrengths(), runStoreAudit(), SupabaseClient, GET(), POST()
...
Cohesion: 0.22
Nodes (5): SCORE, AuditLog, AuditStatus, FixStatus, WinningProduct
...
Cohesion: 0.43
Nodes (5): GET(), plainLen(), runSeoAudit(), SeoAuditResult, SeoProblem
...
Cohesion: 0.47
Nodes (4): anthropic, pickCrossSellSettings(), getProductsDetailed(), GET()
...
- **Why does `createServiceRoleClient()` connect `Community 13` to `Community 0`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 11`, `Community 14`, `Community 15`, `Community 16`, `Community 23`, `Community 24`, `Community 25`, `Community 30`, `Community 32`, `Community 35`, `Community 38`, `Community 71`, `Community 72`, `Community 73`, `Community 76`, `Community 78`, `Community 79`, `Community 80`, `Community 86`, `Community 87`, `Community 99`, `Community 101`, `Community 104`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `Store` connect `Community 11` to `Community 0`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 21`, `Community 24`, `Community 25`, `Community 30`, `Community 32`, `Community 35`, `Community 38`, `Community 48`, `Community 71`, `Community 72`, `Community 73`, `Community 76`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 85`, `Community 86`, `Community 87`, `Community 92`, `Community 99`, `Community 101`, `Community 104`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `logAction()` connect `Community 25` to `Community 32`, `Community 2`, `Community 3`, `Community 6`, `Community 73`, `Community 11`, `Community 12`, `Community 13`, `Community 78`, `Community 14`, `Community 16`, `Community 15`, `Community 76`, `Community 87`, `Community 30`?**
