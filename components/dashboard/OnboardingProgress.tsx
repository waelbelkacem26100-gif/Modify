...
const steps: Step[] = [
  {
    ...
    description: 'Connexion sécurisée par Shopify — 1 minute',
  ...
  },
  {
    ...
    description: '6 analyses spécialisées de votre boutique (~3 min)',
    href: '/dashboard',
    cta: 'Scanner',
  },
  {
    ...
    description: 'Modify corrige, vérifie, et vous montre le gain en €',
