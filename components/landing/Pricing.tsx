    ...
    <section id="pricing" className="py-28">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="font-syne text-4xl md:text-5xl font-bold text-text-primary mb-5">
        ...
        <div className="max-w-md mx-auto">
          <div className="relative bg-surface border-2 border-primary/40 rounded-2xl p-8 glow-primary">
            {/* Popular badge */}
            <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 inline-flex items-center gap-1.5 px-4 py-1 bg-primary rounded-full text-xs font-semibold text-white">
            ...
            <Link
              href="/sign-up"
              className="w-full inline-flex items-center justify-center gap-2 px-6 py-4 bg-primary hover:bg-primary-dark text-white font-semibold rounded-xl transition-all duration-200 text-[15px] hover:shadow-lg hover:shadow-primary/20"
            >
