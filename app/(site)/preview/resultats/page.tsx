...
/**
 * /preview/resultats?token=… — Preview publique TEMPORAIRE de la page Impact &
 * Résultats (ROI + galerie + graphiques) avec les vraies données AquaDrive,
 * sans authentification Clerk. Lecture seule. ⚠️ À RETIRER après la démo.
 */
export default async function PreviewResultatsPage({
  searchParams,
}: {
  ...
  // Admin = plan pro pour la preview.
  const data = await buildSuiviData(store, 'pro', supabase)
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 overflow-y-auto pb-20 min-w-0">
        ...
        <SuiviContent d={data} gallery={<ProofsContent embedded />} />
      </main>
