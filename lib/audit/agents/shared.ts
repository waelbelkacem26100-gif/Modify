...
6bis. DONNÉE MANQUANTE ≠ PROBLÈME CHIFFRÉ : si une source est indisponible (vitrine inaccessible, pas de mesure), tu peux le signaler par UN constat maximum — mais avec "impact_euros": 0 (on ne facture jamais des € sur ce qu'on n'a pas pu vérifier).
